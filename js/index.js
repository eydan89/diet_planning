...
function setData() {
    ...
    let boton1 = document.getElementById("busca");
    ...
    function renderFound(item) {
        ...
        console.log("delete")
        deleteInfo();
        item.nombre = document.getElementById("input-text").value;
        let html = `<div class="mx-2 my-1"><h5>` + item.nombre + "(" + item.name + ")</h5>" +
            `<div class="ltext">`+"<h5>Composición por 100g</h5>\n" +
            "Calorias Totales: " + item.calories + "Kcal<br>" +
            "Proteina: " + item.protein_g + "g<br>" +
            "Carbohidratos: " + item.carbohydrates_total_g + "g<br>" +
            "&nbsp &nbsp &#8627 de los cuales azucares: " + item.sugar_g + "g<br>" +
            "Grasas: " + item.fat_total_g + "g<br>" +
            "&nbsp &nbsp &#8627de las cuales saturadas: " + item.fat_saturated_g + "g<br>" +
            "&nbsp &nbsp &#8627Colesterol: " + item.cholesterol_mg + "mg<br>" +
            "Fibra: " + item.fiber_g + "g<br>" +
            "sodio: " + item.sodium_mg + "mg<br>" +
            "potasio: " + item.potassium_mg + "mg<br></p></div>"
    ...
    function añadirEntrada() {
        ...
        let cantidad = document.getElementById("input-number").value;
    ...
    function añadir(entrada) {
        ...
        <td><img src="trash.png" class="trash hover" onclick="borrar(${entrada.id})"></td> 
